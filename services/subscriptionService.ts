...
export const PLANS: SubscriptionPlan[] = [
  ...
  { id: 'tier_4', name: 'Unlimited', price: 199.99, durationDays: 30, dailyLimit: 1000000, description: 'Unlimited + All Features', quality: 'Gemini 3.1 Pro (Thinking)', hasSkeletonMode: true, hasAutoFill: true, hasMasterEditor: true, hasReferenceUpload: true, hasPdfDownload: true },
  
  // Recruiter Plans
  { id: 'recruiter_free', name: 'Recruiter Free', price: 0, durationDays: 0, dailyLimit: 1, description: '1 AI Search', quality: 'Gemini 1.5 Flash-8B', hasPdfDownload: true },
  { id: 'recruiter_starter', name: 'Recruiter Starter', price: 2500, durationDays: 30, dailyLimit: 10, description: '10 AI Searches', quality: 'Gemini 2.0 Flash-Lite', hasPdfDownload: true },
  { id: 'recruiter_growth', name: 'Recruiter Growth', price: 7500, durationDays: 30, dailyLimit: 30, description: '30 AI Searches', quality: 'Gemini 2.5 Flash', hasPdfDownload: true },
  { id: 'recruiter_pro', name: 'Recruiter Pro', price: 25000, durationDays: 30, dailyLimit: 1000000, description: 'Unlimited AI Searches', quality: 'Gemini 3.1 Pro (Thinking)', hasPdfDownload: true },
];
